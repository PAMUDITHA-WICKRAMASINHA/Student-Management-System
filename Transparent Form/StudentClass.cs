...
namespace Transparent_Form
{
    class StudentClass
    {
        ...
        public bool insertStudent(string fname, string lname, string bdate, string gender, string phone, string address, byte[] img)
        {
       ...
       //create a function edit for student
        public bool updateStudent(int id,string fname, string lname, string bdate, string gender, string phone, string address, byte[] img)
        {
